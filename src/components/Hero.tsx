      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-24 pt-12">
        <div className="max-w-2xl">
          ...
          >
            <a
              href="#menu"
              className="inline-flex justify-center items-center gap-2 bg-[#FFB800] hover:bg-[#e5a600] text-stone-950 font-bold px-8 py-4 rounded-full font-semibold text-lg transition-all"
            >
              View Menu
            </a>
            <a
              href={`tel:${businessDetails.phone.replace(/\\s/g, '')}`}
              className="inline-flex justify-center items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-full font-semibold text-lg backdrop-blur-md transition-all border border-white/10"
            >
